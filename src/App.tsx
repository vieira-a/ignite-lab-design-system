  ...
  return (
    <div className="w-screen h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-200">
      <header className='flex flex-col items-center'>
        <Logo />
        <Heading size='lg' className='text-gray-200 mt-4'>
          Ignite Lab
        </Heading>
      ...
      <form className='flex flex-col gap-4 mt-10 items-stretch w-full max-w-[400px]'>
        ...
        <label htmlFor="remember" className='flex items-center gap-2'>
          ...
          <Text size='sm' className='text-gray-500'>Lembrar por 30 dias?</Text>
        </label>
